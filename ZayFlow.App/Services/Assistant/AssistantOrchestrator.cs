...
public sealed class AssistantOrchestrator : IAssistantOrchestrator
{
    ...
    /// <summary>Phase 3 Ã¢â‚¬â€ Tracks the active execution plan awaiting approval.</summary>
    ...
    {
        // Ã¢â€â‚¬Ã¢â€â‚¬ Phase 3: handle plan-mode follow-ups (approve/reject/skip/retry/abort) Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ Route CodeReview mode Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ Route Refactor mode Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Only for explicit code creation/editing Ã¢â‚¬â€ NOT for chat, sorting, file ops, etc.
        ...
        {
            result.ToolTraceSummary = string.Join(" Ã¯Â¿Â½ ", result.ToolInvocations.Select(tool => $"{tool.Name}: {tool.Status}"));
        }
    ...
    private string SelectModel(AssistantTurnMode mode)
    {
        ...
        return mode switch
        {
            ...
            AssistantTurnMode.Vision => string.IsNullOrWhiteSpace(preferences.PreferredVisionModel)
                ? CloudflareProvider.DefaultVisionModel
                : preferences.PreferredVisionModel,
            _ => string.IsNullOrWhiteSpace(preferences.PreferredChatModel)
                ? CloudflareProvider.DefaultChatModel
                : preferences.PreferredChatModel
        };
    }
    ...
    private static AssistantTurnMode DetectMode(string message, string workspaceRoot, IReadOnlyList<AssistantAttachment> attachments)
    {
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ Weighted scoring: each mode accumulates a relevance score Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ CodeReview signals (exact + fuzzy) Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ Refactor signals (exact + fuzzy) Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ Research signals (exact + fuzzy) Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ Document signals (exact + fuzzy) Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ Desktop action signals (exact + fuzzy) Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Multi-word desktop phrases (exact only Ã¢â‚¬â€ these are unlikely to be fuzzy-matched sensibly)
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ General action verbs Ã¢â€ â€™ DesktopAction (lower weight fallback) Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ Chat signals (informational) Ã¢â€â‚¬Ã¢â€â‚¬
        if (LooksLikeInformationalRequest(n) && !HasExplicitCodeTarget(n))
            scores[AssistantTurnMode.Chat] += 4;

        // Ã¢â€â‚¬Ã¢â€â‚¬ Pick highest score; fallback to Chat Ã¢â€â‚¬Ã¢â€â‚¬
        var best = scores.OrderByDescending(kv => kv.Value).First();
        return best.Value > 0 ? best.Key : AssistantTurnMode.Chat;
    }

    // Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Fuzzy matching helpers Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    /// Short keywords (Ã¢â€°Â¤3 chars) require exact match to avoid false positives.
    /// </summary>
    private static bool ContainsFuzzy(string fullText, string[] words, string keyword)
    {
        ...
        // Only fuzzy-match keywords that are 4+ characters Ã¢â‚¬â€ short words produce too many false hits
        if (keyword.Length < 4)
            return false;
        ...
        {
            // Skip words that are very different in length Ã¢â‚¬â€ can't be a fuzzy match
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Phase 3: Plan Mode helpers Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

    /// <summary>
    /// Phase 3 Ã¢â‚¬â€ Handles user responses to a pending execution plan.
    ...
    private AssistantTurnResult? HandlePlanFollowUp(string message)
    {
        ...
        if (msg is "approve" or "yes" or "go" or "execute" or "run" or "ok")
        {
            ...
            // Plan is now approved Ã¢â‚¬â€ the ViewModel will drive execution
            return result;
        }
        ...
        // Not a plan follow-up Ã¢â‚¬â€ return null to continue normal processing
        return null;
    }

    /// <summary>
    /// Phase 3 Ã¢â‚¬â€ Generates an execution plan and presents it to the user for approval.
    ...
    /// <summary>Phase 3 Ã¢â‚¬â€ Returns the currently pending plan, if any.</summary>
    public ExecutionPlan? GetPendingPlan() => _pendingPlan;

    /// <summary>Phase 3 Ã¢â‚¬â€ Clears the pending plan (e.g. after execution completes).</summary>
