...
/// <summary>
/// Understanding Layer — converts a raw user request + workspace context
...
public sealed class UnderstandingService
{
    ...
    public UnderstandingService(OpenRouterProvider openRouterProvider, ILogger<UnderstandingService> logger)
    {
...
7. List assumptions you're making that could be wrong — these will be verified later.
8. Derive acceptance criteria — what must be true for the output to be correct.
...
""";
    ...
    // ── Phase 2: edit-target detection helpers ──────────────────────────────────────
    ...
    /// Silent on I/O failure — returns an unreadable entry.
    /// </summary>
