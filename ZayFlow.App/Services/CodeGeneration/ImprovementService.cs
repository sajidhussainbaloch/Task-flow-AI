...
/// <summary>
/// Improvement Layer — takes verification findings and applies targeted fixes
...
public sealed class ImprovementService
{
    ...
    public ImprovementService(OpenRouterProvider openRouterProvider, ILogger<ImprovementService> logger)
    {
        ...
        CancellationToken ct = default)
    {
        ...
        // ── Phase 3: detect missing files from completeness errors ────────────────
        ...
        // ── Phase 3: generate missing files identified by FrameworkValidator ──────
...
4. The output MUST be the complete corrected file — not just the changed lines.
...
{""intent"":""create_file"",""message"":""<brief summary of fixes>"",""parameters"":{""fileName"":""<same filename>"",""content"":""<complete corrected source code with \n for newlines>"",""fixesSummary"":""<brief summary of what was fixed>""}}";
    ...
    /// <summary>
    /// Phase 3 — Generate a missing file identified by the framework validator.
