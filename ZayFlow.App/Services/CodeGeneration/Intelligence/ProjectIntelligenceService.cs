...
/// <summary>
/// Project Intelligence Service — analyzes any request to produce a <see cref="ProjectBlueprint"/>.
/// For known frameworks → uses <see cref="FrameworkTemplateCatalog"/> for concrete file manifests.
/// For unknown projects → falls back to AI-driven analysis.
...
public sealed class ProjectIntelligenceService
{
        ...
        CancellationToken ct = default)
    {
        ...
        // ── Step 1: Try known framework detection via catalog ────────────────────
        ...
        // ── Step 2: Check if this is clearly a single-file request ──────────────
        ...
        // ── Step 3: AI-driven analysis for unknown multi-file projects ──────────
    ...
    /// Uses the catalog and heuristics — no AI call needed.
    /// </summary>
    public bool RequiresMultiFile(NormalizedBrief brief)
    {
        ...
        // Known framework → always multi-file
...
""";
    ...
    {
        var goal = brief.Goal ?? "";
        // Try to extract a project name from phrases like "create a todo app" → "todo_app"
