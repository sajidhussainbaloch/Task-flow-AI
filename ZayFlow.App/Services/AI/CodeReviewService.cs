...
/// <summary>
/// Phase 2 — Analyzes code for bugs, security vulnerabilities, performance issues, and best practices.
...
public sealed class CodeReviewService
{
    ...
    public CodeReviewService(OpenRouterProvider openRouterProvider, ILogger<CodeReviewService> logger)
    {
...
## RULES:
- Be thorough but practical — focus on impactful findings first.
