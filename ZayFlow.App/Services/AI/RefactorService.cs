...
/// <summary>
/// Phase 2 — Proposes and generates refactored code with before/after preview.
...
public sealed class RefactorService
{
    ...
    public RefactorService(OpenRouterProvider openRouterProvider, ILogger<RefactorService> logger)
    {
...
- Extract method/function — pull logic into a named method
...
- Restructure — reorganize code layout, improve separation

## RULES:
- parameters.content MUST contain the ENTIRE refactored file — no placeholders, no "..." or "// rest of code".
